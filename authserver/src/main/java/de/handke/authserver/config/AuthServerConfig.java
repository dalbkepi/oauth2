...
public class AuthServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	@Autowired
	public AuthServerConfig(AuthenticationConfiguration authenticationConfiguration, PasswordEncoder passwordEncoder) {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		clients
			...
			.withClient("bank-info-service")
			.secret(passwordEncoder.encode("secret"))
			.authorities("CHECK_AUTH_TOKEN", "GET_ACCOUNT_DETAILS")
